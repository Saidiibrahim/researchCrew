...
if __name__ == "__main__":
    ...
    # search_results = search_and_contents.run("Latest news on the USA stock market")
    # print(search_results)

    # similar = FindSimilar()
    # similar_results = similar.run("https://www.aljazeera.com/economy/2024/6/11/us-stock-market-hits-new-record-ahead-of-interest-rates-decision?traffic_source=rss")
    # print(similar_results)

    get_contents = GetContents()
    get_contents_results = get_contents.run(["https://www.aljazeera.com/economy/2024/6/11/us-stock-market-hits-new-record-ahead-of-interest-rates-decision?traffic_source=rss"])
    print(get_contents_results)